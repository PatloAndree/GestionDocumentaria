...
class Registrar_usuario_model extends CI_Model {
	...
	function getUsuarios(){
		...
		LEFT JOIN especialidades e ON u.especialidad_id = e.especialidad_id
	...
	function addUsuarioNuevo($dataInsert){
	...
	// function deleteUsuario($dataUpdate){
	// 	$this->db->where('usuario_id',$this->usuario_id);
