	...
	<?php if ($this->session->userdata('usuario_tipo') == 1)  : ?>
		<div class="modal-header" id="plomo">
						<h5 class="modal-title titulo" id="exampleModalLabel">ANULADO</h5>
					...
					<div class="modal-body">
						<form name="registros-form" id="registrosEdit-form" method="POST" enctype="multipart/form-data" novalidate>
							<div class="row">
								...
								<div class="col-md-6  d-none">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="registrosEdit-hora_pro" id="registrosEdit-hora_pro" value="<?php echo $registro->hora_pro;?>" readonly >
                                ...
                                <div class="col-md-12 d-none">
                                    <div class="form-group">
                                        <label for="registrosEdit-medico_pro">Médico asignado</label>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" id="editaRegistro">Guardar</button>
	...
	<?php if ($this->session->userdata('usuario_tipo') == 2)  : ?>
		<div class="modal-header" id="plomo">
					...
					<div class="modal-body">
						<form name="registros-form" id="registros-atendido" method="POST" novalidate>
							<div class="row">
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <label for="registrosEdit-msj_anulado">Motivo de registro anulado</label>
								...
								<div class="col-md-12 d-none">
									<div class="form-group">
										<label for="registrosEdit-format">Formato de respuesta <span> <i class="fas fa-download"></i></span></label>
										<?php if($registro->formato_res != "") :?>
												<a href="<?php echo $registro->formato_res; ?>" class="form-control" target="_blank">
													<i class="fas fa-download"></i>
													<spann>Descargar Archivo </span>
					...
					<div class="modal-footer">
						...
						<!-- <button type="button" class="btn btn-primary" id="addregistros">Agregar</button> -->
