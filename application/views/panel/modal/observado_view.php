	...
	<?php if ($this->session->userdata('usuario_tipo') == 1)  : ?>
		<div class="modal-header" id="naranja">
					<h5 class="modal-title" id="exampleModalLabel">REGISTRO OBSERVADO</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					<!-- <form name="registros-observado" id="registros-observado" method="POST" novalidate> -->
					<form name="registrosEdit-form" id="registrosEdit-form"  method="POST" enctype="multipart/form-data" novalidate >
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label for="regis_observacion_resp">Observación</label>
									<textarea class="form-control" name="regis_observacion_resp" id="regis_observacion_resp" cols="10" rows="5">
										<?php echo trim($registro->observacion_resp);?>
									</textarea>
								</div>
							</div>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="telefono" class="form-control" name="registrosEdit-telefono" value="<?php echo $registro->telefono; ?>"  id="registrosEdit-telefono" placeholder="Telefono" maxlength="9" data-parsley-minlength="9" readonly>
								</div>
							</div>
							...
							<div class="col-md-12 d-none">
										<div class="form-group">
											<label for="registrosEdit-msj_anulado">Motivo de registro anulado</label>
											<textarea class="form-control" name="registrosEdit-msj_anulado" id="registrosEdit-msj_anulado" 
											cols="10" rows="2" >
											<?php echo $registro->msj_anulado; ?> 
											</textarea>
				...
				<div class="modal-footer">
						<button type="button" class="btn btn-primary" aria-label="Close" id="editaRegistro">Editar</button>
	...
	<?php if ($this->session->userdata('usuario_tipo') == 2)  : ?>
		<div class="modal-header" id="naranja">
					<h5 class="modal-title" id="exampleModalLabel">OBSERVADO</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
					...
					<form name="registrosEdit-form" id="registrosEdit-form" method="POST" enctype="multipart/form-data" novalidate>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label for="regis_observacion_resp">Observación</label>
									<textarea class="form-control" name="regis_observacion_resp" id="regis_observacion_resp" cols="10" rows="5" readonly>
										<?php echo trim($registro->observacion_resp);?>
									</textarea>
								</div>
							</div>
							...
							<input class="form-control d-none " type="text" value="<?php echo $registro->registro_id; ?>" name="registrosEditar-id" id="registrosEditar-id" readonly>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="registrosEdit-tipodocumento">Documento</label>
											<select name="registrosEdit-tipodocumento" class="form-control" id="registrosEdit-tipodocumento" >
												<!-- <option value="">SELECCIONAR</option> -->
												<?php if ($documentos != '0') : ?>
													<?php foreach ($documentos as $documento) : ?>
														<?php if ($documento->documento_id != '2') : ?>
									...
									<div class="col-md-9 col-sm-12">
										<div class="form-group">
											<label for="registrosEdit-nombre">Nombres y Apellidos</label>
											<input type="text" class="form-control" name="registrosEdit-nombre"  value="<?php echo $registro->nombres; ?>" id="registrosEdit-nombre" placeholder="Nombres completos" >
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="registrosEdit-telefono">Telefono</label>
											<input type="telefono" class="form-control" name="registrosEdit-telefono" value="<?php echo $registro->telefono; ?>"  id="registrosEdit-telefono" placeholder="Telefono" maxlength="9" data-parsley-minlength="9" >
										</div>
									</div>
									...
									<div class="col-md-8">
										<div class="form-group">
											<label for="registrosEdit-correo">Correo electrónico</label>
											<input type="email" class="form-control" name="registrosEdit-correo" value="<?php echo $registro->correo; ?>"  id="registrosEdit-correo" placeholder="Ingrese su correo electronico" >
										</div>
									</div>
