!(function (a) {
				...
				for (a.isArray(o) || (o = [o]), h = 0, i = o.length; h < i; h++)
					if ("number" == typeof o[h] && 0 <= o[h]) {
						...
						for (j = 0, k = n.length; j < k; j++)
							("_all" == o[h] || a(n[j].nTh).hasClass(o[h])) && f(j, m);
			}
				...
				(e !== d && e !== l) ||
					...
					h && h._bAttrSrc
						? (A(h.mData._)(f, i),
						  ...
						  o(h.mData.filter, b))
						: n
						? (h._setter || (h._setter = A(h.mData)), h._setter(f, i))
						: (f[l] = i)),
					l++;
			};
		if (k)
		...
		if (null === l.nTr) {
			for (
				...
				(i = b.aoColumns[j]),
					...
					i.fnCreatedCell &&
						i.fnCreatedCell.call(b.oInstance, h, w(b, d, j), m, d, j);
	...
	function J(b, c, e) {
		...
		if (c) {
			for (e === d && (e = !1), f = 0, g = c.length; f < g; f++) {
				for (j[f] = c[f].slice(), j[f].nTr = c[f].nTr, h = l - 1; 0 <= h; h--)
	...
	function K(b) {
		...
		if (-1 !== a.inArray(!1, c)) la(b, !1);
			...
			(b.bDrawing = !0),
				i !== d &&
					-1 !== i &&
					((b._iDisplayStart = j ? i : i >= b.fnRecordsDisplay() ? 0 : i),
			...
			if (0 !== k.length)
				...
				(e = h.sZeroRecords),
					1 == b.iDraw && "ajax" == Ma(b)
						? (e = h.sLoadingRecords)
						: h.sEmptyTable && 0 === b.fnRecordsTotal() && (e = h.sEmptyTable),
	...
	function M(b) {
		...
		for (var g, h, i, j, k, l, m = b.sDom.split(""), n = 0; n < m.length; n++) {
			...
			g &&
				((i = b.aanFeatures), i[h] || (i[h] = []), i[h].push(g), f.append(g));
		}
			...
			for (d = n[f], e = d.firstChild; e; ) {
				if (
					...
					for (j = g, m = 1 === k, h = 0; h < k; h++)
						for (g = 0; g < l; g++)
							(b[f + g][j + h] = { cell: e, unique: m }), (b[f + g].nTr = d);
				}
				e = e.nextSibling;
			}
	}
	...
	function Y(a, b, c, d, e, f) {
		...
		if ((0 !== Ua.ext.search.length && (c = !0), (g = $(a)), 0 >= b.length))
			...
			for (
				(g || c || f.length > b.length || 0 !== b.indexOf(f) || a.bSorted) &&
					(a.aiDisplay = h.slice()),
					b = a.aiDisplay,
					c = 0;
				c < b.length;
			...
			if (((i = a.aoData[c]), !i._aFilterData)) {
				for (g = [], d = 0, f = j.length; d < f; d++)
					(b = j[d]),
						...
						h.indexOf &&
							-1 !== h.indexOf("&") &&
							((nb.innerHTML = h), (h = ob ? nb.textContent : nb.innerText)),
	...
	function ha(b) {
		...
		return (
			...
			j
				.children()
				.append(b.oLanguage.sLengthMenu.replace("_MENU_", f[0].outerHTML)),
			a("select", j)
	...
	function pa(c) {
		...
		for (
			...
			(e = g[m[d]]),
				null !== e.sWidth && ((e.sWidth = qa(e.sWidthOrig, t)), (u = !0));
		if (h || (!u && !j && !i && l == q(c) && l == p.length))
			...
			if (c.aoData.length)
				for (d = 0; d < m.length; d++)
					(u = m[d]),
						(e = g[u]),
						a(ra(c, u)).clone(!1).append(e.sContentPadding).appendTo(w);
			for (
				a("[name]", l).removeAttr("name"),
					...
					j && k
						...
						? (l.css("width", "auto"),
						  l.removeAttr("width"),
						  l.width() < t.clientWidth && s && l.width(t.clientWidth))
						: i
	...
	function ua(b) {
		...
		for (
			...
			for (i = l[b][0], f = k[i].aDataSort, c = 0, e = f.length; c < e; c++)
				(g = f[c]),
					(h = k[g].sType || "string"),
					l[b]._idx === d && (l[b]._idx = a.inArray(l[b][1], k[g].asSorting)),
					j.push({
						src: i,
						col: g,
						dir: l[b][1],
				...
				? ((e = a.inArray(c, eb(g, "0"))),
				  -1 !== e
						? ((c = i(g[e], !0)),
						  ...
						  null === c ? g.splice(e, 1) : ((g[e][1] = h[c]), (g[e]._idx = c)))
	...
	function za(b) {
		...
		if (h.bSort && h.bSortClasses) {
			for (h = 0, c = e.length; h < c; h++)
				(d = e[h].src),
					a(eb(b.aoData, "anCells", d)).removeClass(f + (2 > h ? h + 1 : 3));
			for (h = 0, c = g.length; h < c; h++)
				(d = g[h].src),
					a(eb(b.aoData, "anCells", d)).addClass(f + (2 > h ? h + 1 : 3));
		}
		b.aLastSort = g;
	}
	function Aa(a, b) {
			...
			c = function (c) {
				if (c && c.time) {
					...
					if (
						-1 === a.inArray(!1, i) &&
						!(
							(0 < (i = b.iStateDuration) && c.time < +new Date() - 1e3 * i) ||
						...
						if (
							...
							for (f = 0, g = c.columns.length; f < g; f++)
								(i = c.columns[f]),
									i.visible !== d && (h[f].bVisible = i.visible),
									i.search !== d &&
										a.extend(b.aoPreSearchCols[f], aa(i.search));
	...
	function Ja(b, c, d, e) {
		...
		return (
			...
			null !== d &&
				((c = a.Event(d + ".dt")), a(b.nTable).trigger(c, e), f.push(c.result)),
			f
		);
	}
	function Ka(a) {
		...
		a.each(
			...
			function (a, c) {
				(Qa.type.order[a + b + "-pre"] = c),
					a.match(/^html\-/) && (Qa.type.search[a + b] = Qa.type.search.html);
			}
		);
	}
	function Pa(a) {
			...
			(this.$ = function (a, b) {
				...
				(this.fnDeleteRow = function (a, b, c) {
					var e = this.api(!0),
						...
						g = f.aoData[a[0][0]];
					return (
						a.remove(), b && b.call(this, f, g), (c === d || c) && e.draw(), g
					);
				}),
			...
			return (
				this.each(function () {
					...
					if ("table" != this.nodeName.toLowerCase())
						...
						(null !== o && "" !== o) ||
							(this.id = o = "DataTables_Table_" + Ua.ext._unique++);
						...
						a.extend(C, Ua.ext.classes, p.oClasses),
							...
							null !== p.iDeferLoading &&
								...
								(B._iRecordsDisplay = o ? p.iDeferLoading[0] : p.iDeferLoading),
						...
						a.extend(!0, D, p.oLanguage),
							...
							null === p.asStripeClasses &&
								(B.asStripeClasses = [C.sStripeOdd, C.sStripeEven]);
							...
							o = function () {
								...
								if (
									...
									0 === c.length || 0 === c.children().length
										...
										: c.length > 0 &&
										  ((B.nTFoot = c[0]), N(B.aoFooter, B.nTFoot)),
									p.aaData)
								)
	...
	(Ra = function (b, c) {
							...
							(f = l[i]),
								(f =
									"cell" === b
										...
										: c.call(p, n[g], f, g, i, k)) !== d && m.push(f);
				}
				return m.length || e
		...
		(Ra.register = Sa = function (b, c) {
			if (a.isArray(b))
				...
				for (
					...
					j ||
						((j = { name: f, val: {}, methodExt: [], propExt: [] }), i.push(j)),
						d === e - 1 ? (j.val = c) : (i = g ? j.methodExt : j.propExt);
				}
		}),
		...
		Sa("draw()", function (a) {
			return this.iterator("table", function (b) {
				"page" === a
					? K(b)
					: ("string" == typeof a && (a = "full-hold" !== a), L(b, !1 === a));
			});
		}),
		Sa("page()", function (a) {
			return a === d
	...
	var vb = function (b, c, e, f, g) {
			...
			for (
				j = typeof c,
					(c && "string" !== j && "function" !== j && c.length !== d) ||
						(c = [c]),
					j = 0,
					k = c.length;
				j < k;
				...
				function (e) {
					...
					return vb(
						...
						function (b) {
							...
							if ((f || (f = yb(e, g)), null !== c && -1 !== a.inArray(c, f)))
								return [c];
		...
		Sa("row().data()", function (a) {
			...
			return a === d
				? b.length && this.length
					...
					: d
				: ((b[0].aoData[this[0]]._aData = a), E(b[0], this[0], "data"), this);
		}),
					...
					f.off(
						...
						0 < eb(g, "_details").length &&
							...
							f.on("column-visibility.dt.DT_details", function (a, b) {
								if (e === b)
									for (var c, d = q(b), f = 0, h = g.length; f < h; f++)
										(c = g[f]),
											c._details &&
					...
					if (a.isArray(b) || b instanceof a)
						...
						b.nodeName && "tr" === b.nodeName.toLowerCase()
							...
							: ((d = a("<tr><td/></tr>").addClass(c)),
							  (a("td", d).addClass(c).html(b)[0].colSpan = q(f)),
							  g.push(d[0]));
				};
			h(b, c),
								...
								for (g = [], h = 0, i = p.length; h < i; h++)
									for (f = p[h], j = 0; j < s; j++)
										(k = { row: f, column: j }),
											e
												? ((l = o[f]),
												  b(k, w(c, f, j), l.anCells ? l.anCells[j] : null) &&
														g.push(k))
												: g.push(k);
								return g;
							}
						...
						q = function (c, d) {
							...
							for (e = 0, g = d.length; e < g; e++)
								if (((r = d[e]), a.isArray(r)))
									(l = a("<" + (r.DT_el || "div") + "/>").appendTo(c)), q(l, r);
								else {
									switch (((j = null), (k = ""), r)) {
										case "ellipsis":
